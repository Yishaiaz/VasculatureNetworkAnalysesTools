...
from NetworkUtilities.GraphToolFormatConverters import convert_gt_to_nx
...
if __name__ == '__main__':
    ...
    torch_geometric_graph = from_networkx(G=nx_graph, group_node_attrs=['radii'], group_edge_attrs=[["length", "radii"]])
    cggm_model = CGMM(dim_node_features=, dim_edge_features=, dim_target=1, readout_class=, config=)
    print(torch.has_mps)